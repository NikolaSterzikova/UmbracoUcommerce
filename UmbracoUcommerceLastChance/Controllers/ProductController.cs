...
namespace UmbracoUcommerceLastChance.Controllers
{
    public class ProductController : RenderMvcController
    {
        ...
        public ActionResult Index(ProductPageViewModel model)
        {
            string variant = GetVariantFromPostData(model.ProductViewModel.Sku, "variation-");
            TransactionLibrary.AddToBasket(1, model.ProductViewModel.Sku, variant);
        ...
        private ActionResult RenderView(bool addedToBasket)
        {
            ...
            Product currentProduct = GetProductMoq();
        ...
        private Product GetProductMoq()
        {
            var product = new Product();
            product.Guid = Guid.NewGuid();
            product.Sku = "test-sku";
            product.Name = "Product moq XXXX";
            return product;
